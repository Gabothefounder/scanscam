-- Phase A: guide_report_* events -> Daily Pulse CTA Shown / CTA Clicked
-- STEP 2 of 2 — Run ONLY after guide_report_cta_phase_a_01_drop.sql succeeds
-- and the verification query returns 0 rows.
--
