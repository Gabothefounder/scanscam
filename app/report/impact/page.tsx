...
const copy = {
  en: {
    question: "Did this affect your identity or accounts?",
    options: [
      "No",
      "Yes — personal information exposed",
      "Yes — account taken over",
      "Not sure",
    ],
    continue: "Continue",
    goBack: "Go back",
  ...
  fr: {
    question: "Est-ce que cela a affecté votre identité ou vos comptes ?",
    options: [
      "Non",
      "Oui — informations personnelles compromises",
      "Oui — compte piraté",
      "Incertain(e)",
    ],
    continue: "Continuer",
    ...
    <main style={styles.container}>
      <section style={styles.main}>
        <div style={styles.card}>
          ...
          <a href={`/report/outcome?lang=${lang}`} style={styles.goBackButton}>
            {t.goBack}
          </a>
        </div>
      </section>
