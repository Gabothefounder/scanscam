...
const copy = {
  en: {
    question: "What were they asking you to do?",
    options: [
      "Click a link",
  ...
  fr: {
    question: "Que vous demandaient-ils de faire ?",
    options: [
      "Cliquer sur un lien",
      "Partager un code ou un mot de passe",
      "Envoyer de l'argent",
    ...
    <main style={styles.container}>
      <section style={styles.main}>
        <div style={styles.card}>
          ...
          <a href={`/report/details?lang=${lang}`} style={styles.goBackButton}>
            {t.goBack}
          </a>
        </div>
      </section>
