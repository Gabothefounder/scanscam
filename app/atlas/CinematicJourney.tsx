...
const ui = {
  en: {
    atlas: "The Vigil", prompt: "Once you see the pattern, you become harder to fool.", promise: "Check a suspicious message, report what happened, or learn how scammers use trust, pressure and emotion.", reassurance: "Built from 1,391 real-world checks. No shame. No one faces the pressure alone.", check: "Check a suspicious message", checkLead: "Paste a message or upload a screenshot for an immediate assessment.", lived: "Tell us what happened", helping: "I’m helping someone", learn: "Explore known patterns",
  ...
  fr: {
    atlas: "La Vigie", prompt: "Quand vous voyez le motif, il devient plus difficile de vous tromper.", promise: "Vérifiez un message suspect, racontez ce qui s’est passé ou découvrez comment les fraudeurs utilisent la confiance, la pression et les émotions.", reassurance: "Construit à partir de 1 391 analyses réelles. Sans honte. Personne ne devrait affronter la pression seul.", check: "Vérifier un message suspect", checkLead: "Collez un message ou téléversez une capture d’écran pour une évaluation immédiate.", lived: "Raconter ce qui s’est passé", helping: "J’aide quelqu’un", learn: "Explorer les motifs connus",
