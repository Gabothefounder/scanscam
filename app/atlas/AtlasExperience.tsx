...
const journey = ["False authority", "Urgency", "Payment request", "Verify independently"];
  ...
  return (
    <main className={styles.page}>
      <header className={styles.atlasHeader}>
        <div>
          <p className={styles.eyebrow}>A ScanScam experiment</p>
      ...
      <section className={styles.workspace} id="map">
        <aside className={styles.introPanel}>
          ...
          <p>Deception follows recognizable paths through emotion, trust, and pressure.</p>
        ...
        <div className={styles.mapShell} aria-label="Interactive map of emotional pressure territories">
          <svg className={styles.map} viewBox="0 0 720 410" role="img" aria-labelledby="map-title map-desc">
            ...
            {territories.map((item) => (
              <g
                key={item.id}
                className={`${styles.territory} ${styles[item.id]} ${selected === item.id ? styles.selected : ""}`}
                role="button"
                tabIndex={0}
            ...
            <text className={styles.seaLabel} x="358" y="205" textAnchor="middle">Sea of Calm</text>
      ...
      <section className={styles.detail} aria-live="polite">
        ...
        <div className={styles.detailLead}>
          <p className={styles.panelKicker}>Territory</p>
          <h2>{territory.name}</h2>
          <p className={styles.short}>{territory.short}</p>
        </div>
        <p className={styles.description}>{territory.description}</p>
        <div>
        ...
        <div className={styles.antidote}>
          <p className={styles.panelKicker}>Path toward calm</p>
