...
const templates:Template[] = [
  {
    id:"gov-pay-en", language:"en", family:"government_impersonation", action:"pay_money", risk:"high",
    tags:["government","payment","authority"],
    texts:[
  ...
  {
    id:"gov-pay-fr", language:"fr", family:"government_impersonation", action:"pay_money", risk:"high",
    tags:["government","payment","authority","fr"],
    texts:[
  ...
  {
    id:"delivery-en", language:"en", family:"delivery_scam", action:"click_link", risk:"medium",
    tags:["delivery","link"],
    texts:[
  ...
  {
    id:"delivery-fr", language:"fr", family:"delivery_scam", action:"click_link", risk:"medium",
    tags:["delivery","link","fr"],
    texts:[
  ...
  {
    id:"account-en", language:"en", family:"account_verification", action:"submit_credentials", risk:"high",
    tags:["account","credentials","urgency"],
    texts:[
  ...
  {
    id:"account-fr", language:"fr", family:"account_verification", action:"submit_credentials", risk:"high",
    tags:["account","credentials","urgency","fr"],
    texts:[
  ...
  {
    id:"recovery-en", language:"en", family:"recovery_scam", action:"pay_money", risk:"high",
    tags:["recovery","crypto","payment"],
    texts:[
  ...
  {
    id:"wrong-number-en", language:"en", family:"social_engineering_opener", action:"reply", risk:"medium",
    tags:["opener","engagement"],
    texts:[
  ...
  {
    id:"wrong-number-fr", language:"fr", family:"social_engineering_opener", action:"reply", risk:"medium",
    tags:["opener","engagement","fr"],
    texts:[
  ...
  {
    id:"benign-en", language:"en", family:"unknown", action:"none", risk:"low",
    tags:["benign"],
    texts:[
  ...
  {
    id:"benign-fr", language:"fr", family:"unknown", action:"none", risk:"low",
    tags:["benign","fr"],
    texts:[
  ...
  {
    id:"thin-en", language:"en", family:"unknown", action:"unknown", risk:"insufficient_context",
    tags:["thin","insufficient"],
    texts:[
      "send me moola",
      "call me",
      "payment?",
  ...
  {
    id:"thin-fr", language:"fr", family:"unknown", action:"unknown", risk:"insufficient_context",
    tags:["thin","insufficient","fr"],
    texts:[
      "envoie-moi l'argent",
      "appelle-moi",
      "paiement?",
...
function variant(text:string,i:number) {
  let value=text
    .replaceAll("{link}",links[i%links.length])
    .replaceAll("{amount}",amounts[i%amounts.length]);
...
const dir=path.resolve("evals/cases"); fs.mkdirSync(dir,{recursive:true});
